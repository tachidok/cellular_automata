...
filename = 'RESLT/current_bp_p0_0_p1_0.dat'
density, current = np.loadtxt(filename, delimiter='\t', unpack=True)
ax1.plot(density, current, label=r'$p_0 = 0.0, p_1 = 0.0$', color='red', linestyle='solid', linewidth=Linewidth)
...
ax1.set_title(r'Density vs Current (p_0 = 0)')
ax1.legend()
plt.show()
...
filename = 'RESLT/velocity_bp_p0_0_p1_0.dat'
...
ax1.set_title(r'Density vs Velocity (p_0 = 0)')
ax2.legend()
plt.show()
