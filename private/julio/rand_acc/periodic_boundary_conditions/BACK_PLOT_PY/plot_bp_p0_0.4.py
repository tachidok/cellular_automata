...
filename = 'RESLT/current_bp_p0_0.4_p1_0.dat'
...
ax1.set_title(r'Density vs Current (p_0 = 0.4)')
ax1.legend()
plt.show()
...
filename = 'RESLT/velocity_bp_p0_0.4_p1_0.dat'
...
ax2.set_title(r'Density vs Velocity (p_0 = 0.4)')
ax2.legend()
plt.show()
