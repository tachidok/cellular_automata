...
namespace CA
{
 ...
 /// CALibError and CALibWarning.
 class CALibException : public std::runtime_error
 {
 ...
 protected:
  ...
  /// location string provided by the CA_EXCEPTION_LOCATION macro
  ...
  CALibException(const std::string &error_description,
 ...
 /// ====================================================================
 class CALibError : public CALibException
 {
 ...
 public:
  ...
  /// CA_EXCEPTION_LOCATION macro
 CALibError(const std::string &error_description,
            const std::string &function_name,
		  const char *location) :
  CALibException(error_description,function_name,location,"ERROR",
 ...
 //====================================================================
 /// An CALibWarning object which should be created as a temporary
 ...
 //====================================================================
 class CALibWarning : public CALibException
 {
  /// Output stream that is used to write the errors
  static std::ostream *Stream_pt;
 ...
 CALibWarning(const std::string &warning_description,
              const std::string &function_name,
		    const char* location) :
  CALibException(warning_description,function_name, location,
 ...
 // output from ca. Its instantiation can be used like std::cout.
 // =======================================================================
 class CAOutput
 {
 ...
 //========================================================================
 // Single (global) instantiation of the CAOutput object -- this
 // is used throughout the library as a "replacement" for std::cout
 //========================================================================
 extern CAOutput ca_output;
