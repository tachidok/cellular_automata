...
cmake ../ \
      -DCELLULAR_AUTOMATON_LIB_TYPE=$lib_type \
      -DCELLULAR_AUTOMATON_BUILD_VERSION=$lib_version \
      -DCELLULAR_AUTOMATON_BUILD_DEMOS=$build_demos \
      -DCELLULAR_AUTOMATON_CONFIGURATION_FILE=$configuration_file \
